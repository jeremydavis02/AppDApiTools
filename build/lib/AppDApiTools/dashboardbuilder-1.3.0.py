...
import json, copy, argparse, difflib, re, base64
...
parser.add_argument('-c', '--config', help='The configuration describing how to build the new dashboard. ', required=False)
